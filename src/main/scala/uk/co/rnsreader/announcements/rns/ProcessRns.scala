...
object ProcessRns {
  ...
  def process(baseUrl: TrustNetBaseUrl)(filter: AnnouncementFilter)(date: DateTime)(implicit client: Client, strategy: Strategy): Task[Vector[Throwable \/ AnnouncementResult]] = {
